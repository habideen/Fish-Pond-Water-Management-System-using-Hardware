<?php
$dashboard = ($script_name=='admin_dashboard')? '#' : 'admin_dashboard.php';
$register = ($script_name=='register_fish_pond')? '#' : 'register_fish_pond.php';
$password = ($script_name=='password')? '#' : 'admin_password.php';
?>
...
<head>
    ...
    <title>IPM - <?php echo $page_title; ?> [Admin]</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-9 mx-auto">
                    ...
                    <p><h4>Admin Section</h4></p>
                    <div class="row p-3 mt-5 text-center" style="background-color: rgba(0,0,0,0.62);">
                        <div class="col-sm-4"><a class="text-light" href="<?php echo $dashboard; ?>">Users</a></div>
                        <div class="col-sm-4"><a class="text-light" href="<?php echo $register; ?>">Reg. Pond</a></div>
