...
if (isset($_POST['update'])) {
	...
	$sql = "SELECT password FROM $dbname.admin_user WHERE username='$username'";
	$count = countRows($sql);
	$row = getRow($sql);
	$old = $row['password'];
                    ...
                    <div style="background-color: #e6e6e6;">
                        <div class="rounded" style="background-color: #eaeaea;">
                            <form class="p-3" method="post">
                                ...
                                <input class="form-control mb-4" type="password" name="current" placeholder="Old password" required>

                                <input class="form-control mb-2" type="password" name="new1" placeholder="New password" min="1" minlenth="8" required>

                                <input class="form-control mb-3" type="password" name="new2" placeholder="Confirm password" minlenth="8" required>
